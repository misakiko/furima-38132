class Order
  ...
  def save
    ...
    Address.create(post_cord: post_cord, area_id: area_id, city: city, block_number: block_number, building: building, phone_number: phone_number, purchase_id: purchase.id)
  end
end
